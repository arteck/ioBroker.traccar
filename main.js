...
// FIX: explicit TLS verification, independent of NODE_TLS_REJECT_UNAUTHORIZED/global axios config
    ...
    async authUser() {
        ...
        const resp = await axios.post(
            ...
            auth,
            {
                ...
                httpsAgent: HTTPS_AGENT, // FIX: explizite TLS-Zertifikatsprüfung
            },
        );
